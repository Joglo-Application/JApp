...
import '../widgets/kelola_stok/tambah_produk_keluar_dialog.dart' show TambahProdukKeluarPage;

class OwnerTambahkanStokKeluarPage extends StatefulWidget {
  const OwnerTambahkanStokKeluarPage({
    super.key,
  ...
  final StokKeluarEntry? existingEntry;

  @override
  State<OwnerTambahkanStokKeluarPage> createState() =>
      _OwnerTambahkanStokKeluarPageState();
}

class _OwnerTambahkanStokKeluarPageState
    extends State<OwnerTambahkanStokKeluarPage> {
  late final String _kode;
  late DateTime _tanggal;
  late String _catatan;
  final List<StokKeluarProdukItem> _produk = [];
  ...
  void initState() {
    ...
    if (existing != null) {
      ...
      _kode = widget.provider.generateKodeKeluar();
        ...
        child: Column(
          ...
          children: [
            ...
            _BottomButtons(
              ...
              onDraft: () => _save(StokKeluarStatus.draft),
              onPostNow: () => _save(StokKeluarStatus.posted),
            ),
          ],
        ),
      ),
  ...
  Future<void> _onTambahProduk() async {
    ...
    final items = await TambahProdukKeluarPage.push(
      context,
...
class _ProdukSection extends StatelessWidget {
  ...
  final ValueChanged<StokKeluarProdukItem> onDelete;
  final void Function(StokKeluarProdukItem, int) onQuantityChanged;
        ...
        ...produk.map(
          (item) => Column(
            children: [
              ...
              _ProdukItemRow(
                item: item,
                hargaLabel: _formatHarga(item.harga),
