...
class TambahProdukProduksiPage extends StatefulWidget {
  ...
  static Future<List<ProduksiStokProdukItem>?> push(
    BuildContext context, {
    List<String> alreadyAdded = const [],
  }) {
    return Navigator.of(context).push<List<ProduksiStokProdukItem>>(
      MaterialPageRoute(
        fullscreenDialog: true,
        builder: (_) => TambahProdukProduksiPage(alreadyAdded: alreadyAdded),
      ),
    );
  }

  @override
  State<TambahProdukProduksiPage> createState() =>
      _TambahProdukProduksiPageState();
}
